...
const AdminCard = ({det}) => {
  ...
  return (
    <div className='Card m-8 ml-16 border w-[80%] border-gray-300 rounded-2xl shadow-neutral-400 shadow-lg cursor-pointer transition-all hover:shadow-zinc-500 hover:shadow-md'>
        ...
        p-1 '>
          ...
          <div className={`absolute bg-zinc-200 top-[70px] right-6 w-32 text-md rounded-2xl transition-all z-20 shadow-md shadow-zinc-400 ${menuclass}`}>
            ...
            <div className='flex flex-col gap-2 mt-4 mb-4'>
                <div className='flex gap-3 justify-center place-items-center text-center p-1 hover:bg-slate-400 transition-colors' onClick={deleteComplaint}>
                  <p>Delete</p>
                  <RiDeleteBinLine/>
                </div>
