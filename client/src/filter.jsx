      ...
      <div className={`MenuBar absolute top-24 left-24 pt-4 pb-4 w-72 flex flex-col place-items-center gap-6 bg-white border border-gray-300 shadow-md shadow-zinc-400 rounded-2xl transition-all ${menuVisibility}`}>
          ...
          <div className='SortBy flex flex-col gap-3'>
            ...
            <div className='flex flex-wrap gap-x-6 gap-y-2 justify-center'>
              <label className='flex gap-2'>
                <p>Name</p>
                <input type='checkbox' checked={sort.name} onChange={(e)=>{
              ...
              <label className='flex gap-2'>
                <p>Age</p>
                <input type='checkbox' checked={sort.age} onChange={(e)=>{
              ...
              <label className='flex gap-2'>
                <p>Title</p>
                <input type='checkbox' checked={sort.title} onChange={(e)=>{
              ...
              <label className='flex gap-2'>
                <p>Date</p>
                <input type='checkbox' checked={sort.date} onChange={(e)=>{
          ...
          <div className='SelectCategory flex flex-col gap-3'>
            ...
            <div className='flex flex-wrap gap-x-6 gap-y-2 justify-center'>
              <label className='flex gap-2'>
                <p>Theft</p>
                <input type='checkbox' checked={search.theft} onChange={(e)=>{
              ...
              <label className='flex gap-2'>
                <p>Threat</p>
                <input type='checkbox' checked={search.threat} onChange={(e)=>{
              ...
              <label className='flex gap-2'>
                <p>Hacking</p>
                <input type='checkbox' checked={search.hacking} onChange={(e)=>{
              ...
              <label className='flex gap-2'>
                <p>Violence</p>
                <input type='checkbox' checked={search.violence} onChange={(e)=>{
              ...
              <label className='flex gap-2'>
                <p>Scam</p>
                <input type='checkbox' checked={search.scam} onChange={(e)=>{
              ...
              <label className='flex gap-2'>
                <p>Bribery</p>
                <input type='checkbox' checked={search.bribery} onChange={(e)=>{
              ...
              <label className='flex gap-2'>
                <p>HateSpeech</p>
                <input type='checkbox' checked={search.hateSpeech} onChange={(e)=>{
              ...
              <label className='flex gap-2'>
                <p>Property</p>
                <input type='checkbox' checked={search.property} onChange={(e)=>{
